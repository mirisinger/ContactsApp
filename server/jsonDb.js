...
let contacts = [
    { id: '1', name: 'Dan Smith', phone: '(123) 745-526657', title: 'BA', avatar_url: 'https://randomuser.me/api/portraits/men/1.jpg' },
    { id: '2', name: 'Alex Alvarez', phone: '(123) 542-5634271', title: 'MA', avatar_url: 'https://randomuser.me/api/portraits/men/4.jpg' },
    { id: '3', name: 'Norman Dirtic', phone: '(724) 124-88573', title: 'Ph.D', avatar_url: 'https://randomuser.me/api/portraits/men/3.jpg' }
...
async function updateContactRepo(id, name, phone, title, avatarUrl) {
    console.log(id, name, phone, title, avatarUrl);
